...
$string['backtofunding'] = 'Back to Funding participation';
...
$string['col_acttype'] = 'Type';
$string['col_firstpart'] = 'First participated';
$string['col_lastpart'] = 'Last participated';
$string['col_engagements'] = 'Interactions';
// Plain-English hover text for every report column header.
$string['col_activity_help'] = 'The activity in the course. Click to open it in Moodle.';
$string['col_acttype_help'] = 'What kind of activity this is (quiz, assignment, page, and so on).';
$string['col_firstpart_help'] = 'The first date this student is recorded as having participated in the activity. Kept permanently, so it survives beyond Moodle’s log-retention window.';
$string['col_lastpart_help'] = 'The most recent date this student participated in the activity.';
$string['col_engagements_help'] = 'How many recorded interactions this student has had with the activity.';
$string['col_activedays_help'] = 'The number of separate days on which this learner was active in the course.';
$string['col_activities_help'] = 'How many different activities the learner has taken part in.';
$string['col_added_help'] = 'The date this record was added.';
$string['col_agreed_help'] = 'The date and time the learner accepted the policy.';
$string['col_assignment_help'] = 'The assignment this submission is for.';
$string['col_attempts_help'] = 'How many times the learner has attempted the quiz.';
$string['col_auth_help'] = 'How the learner signs in — their authentication method, such as manual or email.';
$string['col_avg_help'] = 'The average across the rows behind this figure.';
$string['col_avggrade_help'] = 'The learner’s average grade across their attempts, as a percentage.';
$string['col_badge_help'] = 'The name of the badge that was awarded.';
$string['col_best_help'] = 'The learner’s highest score across all their attempts, as a percentage.';
$string['col_certificate_help'] = 'The name of the certificate.';
$string['col_cohort_help'] = 'The site-wide cohort (a named group of users) the learner belongs to.';
$string['col_competency_help'] = 'The competency being measured.';
$string['col_completed_help'] = 'The date this was completed.';
$string['col_completedn_help'] = 'How many items the learner has completed.';
$string['col_course_help'] = 'The course this row relates to.';
$string['col_courseviews_help'] = 'How many times the learner opened the course in the last 12 months. Older views are not counted, because Moodle only keeps detailed activity logs for a limited time.';
$string['col_created_help'] = 'The date this was created.';
$string['col_department_help'] = 'The learner’s department, taken from their profile.';
$string['col_done_help'] = 'The number of activities the learner has completed so far.';
$string['col_email_help'] = 'The learner’s email address.';
$string['col_enrolled_help'] = 'The date the learner was enrolled.';
$string['col_enrolledn_help'] = 'The number of enrolments — learners in the course, or courses the learner is enrolled in, depending on the report.';
$string['col_events_help'] = 'The total number of logged actions this learner has taken in the course.';
$string['col_expires_help'] = 'The date the certificate expires. Blank means it does not expire.';
$string['col_firstact_help'] = 'The date of the learner’s first recorded activity in the course.';
$string['col_firstseen_help'] = 'The date the learner was first active in the course.';
$string['col_grade_help'] = 'The learner’s grade.';
$string['col_graded_help'] = 'How many of the submissions have been marked.';
$string['col_idle_help'] = 'How long it has been since the learner was last active.';
$string['col_issued_help'] = 'The date the certificate was issued.';
$string['col_joined_help'] = 'The date the learner joined.';
$string['col_lastaccess_help'] = 'The date the learner last accessed this.';
$string['col_lastact_help'] = 'The date of the learner’s most recent recorded activity in the course.';
$string['col_lastpost_help'] = 'The date of the learner’s most recent forum post.';
$string['col_learner_help'] = 'The learner’s full name.';
$string['col_learners_help'] = 'The number of learners.';
$string['col_method_help'] = 'How the learner was enrolled — the enrolment method, such as manual or self enrolment.';
$string['col_oftotal_help'] = 'The total number of items the “done” count is measured against.';
$string['col_pending_help'] = 'How many items are still outstanding.';
$string['col_policy_help'] = 'The name of the site policy.';
$string['col_posts_help'] = 'How many forum posts the learner has made.';
$string['col_progress_help'] = 'How far through the course the learner is, as a percentage of tracked activities completed.';
$string['col_quiz_help'] = 'The name of the quiz.';
$string['col_role_help'] = 'The role the user holds.';
$string['col_scope_help'] = 'Where the role applies — for example a single course or the whole site.';
$string['col_scorm_help'] = 'The name of the SCORM package.';
$string['col_status_help'] = 'The current status of this row.';
$string['col_submitted_help'] = 'The date the assignment was submitted.';
$string['col_submitted_n_help'] = 'How many assignments the learner has submitted.';
$string['col_tracks_help'] = 'Whether this course has completion tracking switched on.';
$string['col_updated_help'] = 'The date this was last updated.';
$string['col_waiting_help'] = 'How long the submission has been waiting to be marked.';
...
$string['digest_body'] = 'You have {$a->count} assessment submission(s) waiting to be marked. Open your marking queue: {$a->link}';
$string['digest_body_html'] = '<p>You have <strong>{$a->count}</strong> assessment submission(s) waiting to be marked.</p><p><a href="{$a->link}">Open your marking queue</a></p>';
$string['digest_subject'] = 'You have {$a} assessment(s) to mark';
...
$string['filter_trainer'] = 'Teacher / Non-Editing Teacher';
...
$string['grain_activity'] = 'One row per activity';
...
$string['kpi_amber'] = 'Near-target cut-off (amber)';
$string['kpi_amber_desc'] = 'The amber (watch-zone) boundary, 0–100. Values that reach green are on target; values between amber and green are near; values past amber are off target.';
$string['kpi_dir_higher'] = 'Higher is better: the gauge reads green at or above the green cut-off, amber between amber and green, and red below amber.';
$string['kpi_dir_lower'] = 'Lower is better: the gauge reads green at or below the amber cut-off, amber up to the green cut-off, and red above it.';
$string['kpi_green'] = 'On-target cut-off (green)';
$string['kpi_green_desc'] = 'The green (on-target) boundary, 0–100. This is the level at which the gauge is considered on target.';
$string['kpi_target'] = 'Target';
$string['kpi_target_desc'] = 'The goal line shown on the “where it stands” scale, 0–100. Display only — it marks the goal and does not change the colour bands.';
$string['kpitargets_intro'] = 'Set the cut-offs for each KPI gauge. Each field is a percentage from 0 to 100. Leave a field at its default to keep the shipped value. Changes take effect immediately — the stored numbers are not affected, only the colour banding.';
$string['kpitargets_menu'] = 'Beacon KPI targets';
...
$string['m_marking_backlog_days'] = 'Longest marking wait';
$string['m_marking_backlog_days_expl'] = 'How many days the oldest still-unmarked submission has been waiting. A rising number is the early warning that marking is falling behind — before learners start chasing feedback.';
$string['m_marking_backlog_days_note'] = 'days the oldest submission has waited';
$string['m_marking_timeliness'] = 'Marked within 7 days';
$string['m_marking_timeliness_expl'] = 'The share of graded submissions that were marked within seven days of being submitted — the service level on turnaround, not just whether work is eventually graded.';
$string['m_marking_timeliness_note'] = 'submissions graded within a week';
...
$string['markingdigest'] = 'Send daily marking digest email';
$string['markingdigest_desc'] = 'Once a day, email each trainer who has submissions waiting a short note with the count and a link to their marking queue. The email contains only the count and a link — never learner data.';
$string['markingheading'] = 'Marking queue';
$string['markingheading_desc'] = 'The daily digest email that tells each trainer how many submitted assessments are still waiting to be marked. Counts are precomputed hourly by a scheduled task, so nothing is calculated on page load.';
...
$string['scope_courses'] = 'Showing only learners in the {$a} course(s) you teach:';
$string['selectall'] = 'Select all';
$string['scope_none'] = 'You are not assigned as a teacher on any course, so no learner data is shown. Ask your administrator if this looks wrong.';
$string['settings_menu'] = 'Beacon settings';
$string['teacherroles_heading'] = 'Teacher roles';
$string['teacherroles_heading_desc'] = 'Choose which of your site\'s roles Beacon should treat as teachers when scoping reports to the learners a teacher is responsible for. Reads your real roles, so custom roles (Trainer, Assessor, and so on) work — not just Moodle\'s built-in teacher roles. Leave both at their defaults to keep Moodle\'s standard behaviour.';
$string['teacherroles_course'] = 'Course-level teacher roles';
$string['teacherroles_course_desc'] = 'Holders of these roles see every learner in a course they hold the role on. Choose this for roles that are responsible for a whole course. Default: roles based on Moodle\'s Teacher (editing) role.';
$string['teacherroles_group'] = 'Group-level teacher roles';
$string['teacherroles_group_desc'] = 'Holders of these roles see only the learners in groups they share on the course. If a course has no groups, they see the whole course (there is no group boundary to apply). Default: roles based on Moodle\'s Non-editing teacher role.';
...
$string['task_marking_digest'] = 'Send Beacon daily marking-queue digest';
$string['task_marking_refresh'] = 'Refresh Beacon marking-queue counts';
$string['task_participation'] = 'Harvest Beacon activity participation from the log';
...
// Trainer-scoped marking queue (v1.8.2).
$string['r_student_activity'] = 'Student activity';
$string['r_student_activity_desc'] = 'Every activity a learner has participated in within a course, with the first and last participation date and the number of interactions. Built from durable participation records that are kept permanently, so the evidence survives beyond Moodle’s log-retention window. Opened from the Activities count on the Funding participation report.';
$string['r_my_marking_queue'] = 'My marking queue';
$string['r_my_marking_queue_desc'] = 'Submitted assessments still waiting to be marked, scoped to you: administrators see everything, editing teachers see their whole course, and non-editing teachers see only learners in the groups they belong to. Independent of due dates, so it works for rolling intakes.';
