...
class icons {
    ...
    private const PATHS = [
        'users' => '<path d="M17 20v-2a4 4 0 00-4-4H7a4 4 0 00-4 4v2" stroke="currentColor" stroke-width="1.9" '
        ...
        'pulse' => '<path d="M3 12h4l2-6 4 12 2-6h6" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" '
        ...
        'flag' => '<path d="M6 21V4M6 4h11l-2 3 2 3H6" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" '
            . 'stroke-linejoin="round"/>',
        'play' => '<circle cx="12" cy="12" r="8.5" stroke="currentColor" stroke-width="1.8"/><path d="M10 8.5l5 3.5-5 3.5z" '
            . 'fill="currentColor"/>',
        ...
        'star' => '<path d="M12 4l2.2 4.8L19 9.4l-3.6 3.4.9 5.2L12 15.6 7.7 18l.9-5.2L5 9.4l4.8-.6L12 4z" '
            . 'stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/>',
        'moon' => '<path d="M20 14.5A8 8 0 019.5 4 8 8 0 1020 14.5z" stroke="currentColor" stroke-width="1.8" '
            . 'stroke-linejoin="round"/>',
        'shield' => '<path d="M12 3l7 3v5c0 4.4-3 8-7 10-4-2-7-5.6-7-10V6l7-3z" stroke="currentColor" stroke-width="1.8" '
            . 'stroke-linejoin="round"/>',
        ...
        'check' => '<circle cx="12" cy="12" r="8.5" stroke="currentColor" stroke-width="1.8"/>'
            . '<path d="M8.5 12l2.5 2.5 4.5-5" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" '
            . 'stroke-linejoin="round"/>',
        ...
        'pen' => '<path d="M4 20l4-1L19 8a2.1 2.1 0 00-3-3L5 16l-1 4z" stroke="currentColor" stroke-width="1.8" '
            . 'stroke-linejoin="round"/>',
        ...
        'chart' => '<path d="M4 19V5M4 19h16M8 16v-4M12 16V8M16 16v-6" stroke="currentColor" stroke-width="1.9" '
